...
This implementation follows the original U-Net architecture with instance normalization
...
class UNet(nn.Module):
    ...
    def __init__(self,
        ...
        # self.conv2[-1].weight.data = self.conv2[-1].weight.data * 0.025
    ...
    def forward(self, x):
        ...
        # output = torch.view_as_real(x['unet_input']).squeeze(1).reshape(-1,2,256,256)
        output = x
